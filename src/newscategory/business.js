...
const BusinessActivity = () => {
  ...
  const showUnreadNewsNotif = () => {
    Toast.showWithGravity(
      "Hy! You have got " +
        `${categoryID(getLatestNews, businessCategoryId).length}` +
  ...
  return loading ? (
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <Swiper
        ...
        cards={categoryID(getLatestNews, businessCategoryId)}
        cardIndex={0}
        ...
        onSwiped={(cardIndex) => {
          ...
          setNewsUrl(categoryID(getLatestNews, businessCategoryId)[cardIndex].news_url);
