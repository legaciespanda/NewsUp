...
const MarketingActivity = () => {
  ...
  const showUnreadNewsNotif = () => {
    Toast.showWithGravity(
      "Hy! You have got " +
        `${categoryID(getLatestNews, marketingCategoryId).length}` +
  ...
  return loading ? (
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <Swiper
        ...
        cards={categoryID(getLatestNews, marketingCategoryId)}
        cardIndex={0}
        ...
        onSwiped={(cardIndex) => {
          ...
          setNewsUrl(categoryID(getLatestNews, marketingCategoryId)[cardIndex].news_url);
