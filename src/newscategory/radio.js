...
const RadioActivity = () => {
  ...
  const showUnreadNewsNotif = () => {
    Toast.showWithGravity(
      "Hy! You have got " +
        `${categoryID(getLatestNews, radioCategoryId).length}` +
  ...
  return loading ? (
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <Swiper
        ...
        cards={categoryID(getLatestNews, radioCategoryId)}
        cardIndex={0}
        ...
        onSwiped={(cardIndex) => {
          ...
          setNewsUrl(categoryID(getLatestNews, radioCategoryId)[cardIndex].news_url);
