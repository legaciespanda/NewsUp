...
const AdvertActivity = () => {
  ...
  const showUnreadNewsNotif = () => {
    Toast.showWithGravity(
      "Hy! You have got " +
        `${categoryID(getLatestNews, advertCategoryId).length}` +
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <Swiper
        ...
        onSwiped={(cardIndex) => {
          ...
          setNewsUrl(categoryID(getLatestNews, advertCategoryId)[cardIndex].news_url);
