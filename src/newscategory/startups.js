...
const StartupsActivity = () => {
  ...
  const showUnreadNewsNotif = () => {
    Toast.showWithGravity(
      "Hy! You have got " +
        `${categoryID(getLatestNews, startupsCategoryId).length}` +
  ...
  return loading ? (
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <Swiper
        ...
        cards={categoryID(getLatestNews, startupsCategoryId)}
        cardIndex={0}
        ...
        onSwiped={(cardIndex) => {
          ...
          setNewsUrl(categoryID(getLatestNews, startupsCategoryId)[cardIndex].news_url);
...
export default StartupsActivity;
